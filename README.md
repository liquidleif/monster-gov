...
3. New: We'll launch DAOmon as a separate collection on a new chain and the only entry is $PMON. Read more about DAOmon [here](#DAOmon).

4. Staked DAOmon and/or $PMON will be substantial for CS rewards.
